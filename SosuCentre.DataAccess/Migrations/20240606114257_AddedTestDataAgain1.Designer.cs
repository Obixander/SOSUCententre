...
namespace SosuCentre.DataAccess.Migrations
{
    ...
    [Migration("20240606114257_AddedTestDataAgain1")]
    partial class AddedTestDataAgain1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SosuCentre.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 6, 15, 42, 56, 838, DateTimeKind.Local).AddTicks(3142),
                            TimeStart = new DateTime(2024, 6, 6, 13, 42, 56, 838, DateTimeKind.Local).AddTicks(3097)
                        });
                });
