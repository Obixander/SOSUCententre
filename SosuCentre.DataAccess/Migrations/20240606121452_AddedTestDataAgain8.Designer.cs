...
namespace SosuCentre.DataAccess.Migrations
{
    ...
    [Migration("20240606121452_AddedTestDataAgain8")]
    partial class AddedTestDataAgain8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SosuCentre.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 6, 16, 14, 52, 543, DateTimeKind.Local).AddTicks(6960),
                            TimeStart = new DateTime(2024, 6, 6, 14, 14, 52, 543, DateTimeKind.Local).AddTicks(6921)
                        });
                });
