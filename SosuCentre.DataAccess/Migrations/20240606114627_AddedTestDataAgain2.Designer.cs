...
namespace SosuCentre.DataAccess.Migrations
{
    ...
    [Migration("20240606114627_AddedTestDataAgain2")]
    partial class AddedTestDataAgain2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SosuCentre.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 6, 15, 46, 27, 200, DateTimeKind.Local).AddTicks(4977),
                            TimeStart = new DateTime(2024, 6, 6, 13, 46, 27, 200, DateTimeKind.Local).AddTicks(4937)
                        });
                });
