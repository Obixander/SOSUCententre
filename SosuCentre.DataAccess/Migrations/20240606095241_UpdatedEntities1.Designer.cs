...
namespace SosuCentre.DataAccess.Migrations
{
    ...
    [Migration("20240606095241_UpdatedEntities1")]
    partial class UpdatedEntities1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SosuCentre.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 6, 13, 52, 40, 704, DateTimeKind.Local).AddTicks(3925),
                            TimeStart = new DateTime(2024, 6, 6, 11, 52, 40, 704, DateTimeKind.Local).AddTicks(3881)
                        });
                });
