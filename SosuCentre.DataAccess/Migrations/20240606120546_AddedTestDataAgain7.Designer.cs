...
namespace SosuCentre.DataAccess.Migrations
{
    ...
    [Migration("20240606120546_AddedTestDataAgain7")]
    partial class AddedTestDataAgain7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SosuCentre.Entities.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ResidentId = 1,
                            TimeEnd = new DateTime(2024, 6, 6, 16, 5, 45, 722, DateTimeKind.Local).AddTicks(9921),
                            TimeStart = new DateTime(2024, 6, 6, 14, 5, 45, 722, DateTimeKind.Local).AddTicks(9881)
                        });
                });
