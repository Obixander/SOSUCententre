...
namespace SosuCentre.DataAccess
{
    public class SosuCentreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MedicineTask>().Property(x => x.SubTaskId).HasColumnName("MedicineTaskId");
            modelBuilder.Entity<MedicineTask>().Property("AssignmentId1").HasColumnName("MedicinAssignmentId");
            //#region Address
            ...
            //#region MedicineTask
            //modelBuilder.Entity<MedicineTask>().HasData(new { SubTaskId = 2, MedicineId = 1, Amount = 2, Unit = "dl", IsCompleted = false });
            //#endregion
